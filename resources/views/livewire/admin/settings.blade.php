        ...
        <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 sm:p-8 space-y-5">
            ...
            <div>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <input wire:model="skm_url" id="skm_url" type="url" class="flex-1 text-base sm:text-sm py-2.5 px-3 bg-white border border-slate-300 rounded-xl text-slate-900 focus:ring-primary-500 focus:border-primary-500 shadow-xs transition-colors" placeholder="https://skm.go.id/share/instansi/..." required />
                    @if($skm_url)
