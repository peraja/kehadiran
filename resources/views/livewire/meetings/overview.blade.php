...
new #[Layout('layouts.app')] class extends Component {
    ...
    public function executeSign(BsreEsignService $esignService): void
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error('TTE Single Error: ' . $e->getMessage());
        ...
        <div class="p-6 sm:p-8">
            ...
            <form wire:submit="executeSign" class="space-y-5">
                ...
                <div x-data="{ showPassphrase: false }">
                    <label for="passphrase_single" class="block text-sm font-bold text-slate-700 mb-1">Passphrase</label>
                    <div class="relative">
