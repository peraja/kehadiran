                ...
                <div class="flex grow flex-col overflow-y-auto bg-slate-900 px-6 pb-4 shadow-2xl">
                    ...
                    <nav class="flex flex-1 flex-col mt-6">
                        <ul role="list" class="flex flex-1 flex-col gap-y-2">
                            ...
                            <li>
                                <a href="{{ route('meetings.index') }}" wire:navigate @click="sidebarOpen = false"
                            ...
                            <li>
                                <a href="{{ route('meetings.history') }}" wire:navigate @click="sidebarOpen = false"
                            ...
                            <li class="mt-4">
                                ...
                                <a href="{{ route('users.index') }}" wire:navigate @click="sidebarOpen = false"
                            ...
                            <li class="mt-1">
                                <a href="{{ route('opd.index') }}" wire:navigate @click="sidebarOpen = false"
                            ...
                            <li class="mt-1">
                                <a href="{{ route('admin.audit-logs') }}" wire:navigate @click="sidebarOpen = false"
                            ...
                            <li class="mt-1">
                                <a href="{{ route('admin.settings') }}" wire:navigate @click="sidebarOpen = false"
                            ...
                            <li class="mt-4">
                                ...
                                <a href="{{ route('opd.settings') }}" wire:navigate @click="sidebarOpen = false"
