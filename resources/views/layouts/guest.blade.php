...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta property="og:description" content="Aplikasi Manajemen Rapat - Pemerintah Kabupaten Sinjai">
        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
            <div>
                <a href="/" wire:navigate>
                    <img src="{{ asset('img/logo.png') }}" alt="Logo Pemkab Sinjai" class="w-24 h-auto drop-shadow-sm" />
                </a>
            </div>
